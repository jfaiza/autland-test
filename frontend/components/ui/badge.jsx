  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      color: {
        ...
        "31D0AA": "border-[#31D0AA] bg-background text-foreground",
        "a9a9a949": "border-[#a9a9a949] bg-background text-foreground",
      },
      variant: {
        outline: "border border-current bg-background  ",
        soft: "text-current bg-opacity-10  hover:text-primary-foreground",
        halfRounded: " text-current bg-opacity-10  hover:text-primary-foreground rounded-[0.9rem]"
      },
    },
    compoundVariants: [
      {
