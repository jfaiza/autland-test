    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="p-2">
        ...
        {/* <DropdownMenuItem
          ...
          className={cn(
            "p-2 font-medium text-sm text-default-600 hover:bg-primary hover:text-primary-foreground  blue:hover:bg-background cursor-pointer mb-[2px]",
            {
              "bg-primary text-primary-foreground": theme === "blue",
            }
          )}
        >
          <Device className="w-5 h-5 mr-2" />
          <span className="mr-2">Dark Blue</span>
          <Check
            className={cn("w-4 h-4 flex-none ml-auto text-default-700", {
              hidden: theme !== "blue",
            })}
